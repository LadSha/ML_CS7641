...
#learning curve
def create_learning_curve(models):
...
if __name__=="__main__":
    ...
    grid_search(parameters, scoring="f1", refit="f1", model=model)
    prepare_val_curve('max_depth',np.arange(1,20,1),"f1","DTClassifier")
    prepare_val_curve('min_samples_leaf', np.arange(1, 10, 1), "f1", "DTClassifier")
